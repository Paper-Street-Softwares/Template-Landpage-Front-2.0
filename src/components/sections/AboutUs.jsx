  ...
  return (
    <div className="font-mainFont">
      ...
      <div className= "Caixa flex w-full justify-between items-center phone1:flex-col desktop1:flex-row">
        ...
        <div className="image-container flex justify-center phone1:w-[100%] phone1:h-[100%] phone2:w-[100%] phone2:h-[100%] phone3:w-[100%] phone3:h-[100%] tablet1:w-[100%] tablet1:h-[100%] tablet2:w-[100%] tablet2:h-[100%] desktop1:w-[50%] desktop1:h-[100%] desktop2:w-[40%] desktop2:h-[100%]">
