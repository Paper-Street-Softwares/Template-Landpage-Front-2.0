...
export default function Numbers() {
  ...
  return (
    <div
      className={`flex justify-center bg-red-500 bg-center bg-no-repeat bg-fixed bg-cover`}
      style={{
        backgroundImage: `url(${content.texts.numbers.backgroundImg})`,
      }}
    >
      <div className="flex justify-center w-full bg-secondary desktop1:bg-transparent">
