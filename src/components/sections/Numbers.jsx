  ...
  return (
    ...
    >
      <div className="flex justify-center w-full">
        <div className="w-[90%] max-w-[1215px] gap-[46px] flex flex-col text-center desktop1:flex-row justify-between items-center py-[64px] desktop1:py-[96px] text-secondary">
