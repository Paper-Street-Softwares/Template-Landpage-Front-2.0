  ...
  return (
    <div className="">
      <div className="font-mainFont py-[26px] phone1:w-[100%] phone2:py-[48px]">
        ...
        />
        <div className="desktop1:mt-[5%] desktop1:py-[48px] ">
          <AcidentComponent>
            <div className=" desktop1:flex desktop1:flex-row-reverse desktop1:gap-[5%] desktop3:justify-between ">
              <div className="mb-[5%] tablet1:mb-[5%]">
                <img
                  className="size-[100%] desktop1:size-[100%]"
                  src={imgPastilhaCloro}
                />
              </div>
              <div className=" desktop1:w-[55%] desktop3:w-[46%] desktop3:h-[53vh]">
                <ArticleAcident
        ...
        <div className="">
          <AcidentComponent>
            <div className=" desktop1:flex desktop1:flex-row desktop1:justify-between">
              <div className="mb-[10%] mt-[5%] phone2:mb-[5%] phone3:mb-[0%] tablet1:mt-[4%] tablet1:mb-[-3%] tablet2:mb-[3%] desktop1:w-[47%] desktop1:mt-[0%] desktop1:mb-[0%] desktop3:w-[46%]">
                <img
                  className="size-[100%] desktop1:size-[100%] desktop3:h-auto desktop3:size-[100%]"
                  src={resgateAcidente}
                />
              </div>
              <div className=" flex flex-col mt-[-4%] phone3:mt-[3%] desktop1:w-[48%] desktop1:mt-[-1%] desktop3:w-[47.3%] desktop3:relative desktop3:left-[1%]">
