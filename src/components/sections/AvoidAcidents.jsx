      ...
      <div className="font-mainFont phone1:w-[100%] pb-[8px] phone1:pt-[48px] tablet1:pb-0">
          ...
          <div className="desktop1:w-[48.5%] desktop3:w-[46.3%]">
            ...
            <div className=" text-quaternary phone1:w-[100%] phone1:font-normal phone1:text-paragraph3 phone1:leading-[21px] desktop3:w-[100%]">
              <p>
                ...
                queimaduras na pele e até incêndios, como é o caso dos oxidantes
                e dos corrosivos. <br />
                <br />
                Nunca reutilize embalagens vazias, mesmo depois de serem
                lavadas. Elas podem acabar sendo usadas por pessoas desavisadas,
                crianças e até animais, e isso pode causar grande desconforto e
                danos à saúde.
              </p>
            </div>
          </div>
        ...
        <div className="desktop1:flex desktop1:flex-row desktop1:justify-between ">
          ...
          <div className=" desktop1:w-[47.5%] desktop3:w-[46.3%]">
            <div className=" text-quaternary phone1:w-[100%] phone1:font-normal phone1:text-paragraph3 phone1:leading-[21px] desktop3:w-[100%]">
              <p>
                Utilize sempre um balde plástico pequeno para fazer a dissolução
                do cloro ou de outro produto em pó, como barrilha, sulfato de
                alumínio, elevador de alcalinidade, entre outros. Esse balde
                deverá sempre estar guardado em lugar seguro e não poderá ser
                ...
                <br />
                Tomando todos esses cuidados e alguns relacionados à integridade
                física dos usuários, você estará garantindo diversão segura para
                todos os banhistas, inclusive crianças e idosos. <br />
                <br />
