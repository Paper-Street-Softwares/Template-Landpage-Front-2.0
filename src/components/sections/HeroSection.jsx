        ...
        <div className="flex items-center">
          <div className="w-full text-white justify-evenly pb-[30px]">
            ...
            <div className="flex flex-col desktop1:flex-row mx-auto mb-[40px] w-[90%] max-w-[1215px] items-center gap-10 tablet2:gap-14 desktop3:gap-20">
              <div className=" desktop1:w-[580px] flex flex-col gap-8">
                <MotionDivLeftToRight>
                  <div className=" text-black font-bold leading-[74px] text-center desktop1:text-left text-title3 phone1:text-title5 phone3:text-title6 tablet1:text-title7 desktop1:text-[66px]">
                    <h1 className="">
                      Proteja o que <br />
