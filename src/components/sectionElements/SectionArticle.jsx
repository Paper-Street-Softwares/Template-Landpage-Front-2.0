	...
	return (
		<div className= "flex w-100% justify-between items-center flex-col desktop1:flex-row phone1:pt-[5%] ">
			<div className="  w-[100%] gap-[5%] desktop1:w-[200%] desktop3:w-[200%]">
				<h3 className='pb-[3%] text-quaternary font-medium text-paragraph3 leading-[24%] phone2:pb-[5%] phone3:text-paragraph4 phone3:leading-[27%] tablet1:pb-[3%] desktop1:text-paragraph4 desktop1:pb-[3%]'>{articleSubtitle}</h3>
				<h1 className='font-medium text-title2 leading-[150%] text-primary tablet2:mb-[-2%] desktop1:text-title4 desktop1:size-[120%] desktop3:pt-[4%] '>{articleTitle}</h1>
				<p className=' phone1:pt-[5%] text-quaternary font-normal text-paragraph3 leading-[150%] desktop2:size-[100%]'>{articleParagraphfirst}</p>
				<p className=" flex pt-[4%] text-quaternary font-normal text-paragraph3 leading-[150%] desktop2:size-[100%] desktop3:pt-[10%] ">{articleParagraphTwo}</p>
                <p className=" flex pt-[4%] text-quaternary font-normal text-paragraph3 leading-[150%] desktop2:size-[100%] desktop3:pt-[10%]">{articleParagraphThree}</p>
