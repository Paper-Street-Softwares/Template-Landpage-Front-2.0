...
export default function ListGroup() {
  ...
  return (
    <ul
      className={`h-10 my-auto flex items-center justify-end tablet1:items-center tablet1:flex-wrap tablet1:gap-2 tablet2:gap-4 desktop1:gap-6 desktop2:gap-8 w-[88%]  font-semibold text-paragraph3 font-poppins ${
